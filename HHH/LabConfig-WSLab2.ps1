...
$LabConfig = @{
    ...
    VMs                         = @()
    ServerParentPath            = "C:\ClusterStorage\Volume2\WSLab\ParentDisks"  # In case the parent disks are not under $PSScriptRoot. Useful in case of multiple labs over one set of parentdisks
}
