...
$LabConfig = @{
    ...
    ServerParentPath            = "C:\ClusterStorage\Volume3\WSLab\ParentDisksNew"  # In case the parent disks are not under $PSScriptRoot. Useful in case of multiple labs over one set of parent disks
}
# Windows Server 2019
